 ...
 * negotiating with these moves slightly less annoying. Moves are made with 19 bytes, which are:
 * <code><pre>
 * 
 ...
 * 
 * </code></pre>
 * the flag indicates special events in a move, such as promotion, castling, or en passant.
 * The c is capture -- a boolean, really. Typ is for type, aka the piece that is moving.
 * To is 6 bits representing the 0..63 locations we can move from, and from is where we're moving from.
 */
public class Move 
{
