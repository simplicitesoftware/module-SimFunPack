...
import org.simplicite.chess.eval.SimpleEvaluate;
...
public class Tournament
{
	...
	private int[] playGame(boolean p1_is_white) {
		...
		while (time1 > 0 && time2 > 0 && !b.isEndOfGame())
		{
			...
			{
				FullSearch bot = new FullSearch(eval2, depth2);
				long start = System.currentTimeMillis();
				BestMove bm = bot.getBestMove(b);
				if (b.moveNumber % 2 != 0)
					System.out.print( (b.moveNumber / 2 + 1) + ". ");
