...
.logon-death-star::before {
    ...
    Spaceship.sprite = null;
    Spaceship.spriteGrey = null; // pre-filtered greyscale copy, used for spent HP icons
    ...
    class BorderAlien extends Alien {
        ...
        // BorderAlien.speed caches the levelRamp() result, refreshed here whenever levelNumber changes
        static refreshSpeed() {
